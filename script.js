...
const translations = {
  uk: {
    pageTitle: "Кирило Терещук — Product Designer",
    pageDescription: "Портфоліо Кирила Терещука — продуктового дизайнера, який спрощує складні цифрові продукти.",
    skip: "Перейти до змісту",
    navAria: "Головна навігація",
    mobileNavAria: "Мобільна навігація",
    languageAria: "Мова сайту",
    heroVisualAria: "Абстрактна композиція продуктових інтерфейсів",
    caseAreasAria: "Напрями роботи",
    close: "Закрити",
    menu: "Меню",
    navWork: "Кейси",
    navProcess: "Процес",
    ...
    heroLineOne: "Перетворюю складні",
    heroLineTwo: "продукти на зрозумілі.",
    heroBody: "Product Designer із 8+ роками досвіду. Проєктую мобільні й вебпродукти — від логіки та користувацьких сценаріїв до готового UI.",
    viewWork: "Переглянути кейси",
    contactMe: "Зв’язатися",
    visualProduct: "Огляд продукту",
    visualFlow: "Сценарій",
    visualClear: "Зрозумілий наступний крок",
    visualQuest: "Наступний квест",
    visualAction: "Перетворіть дію на вплив",
    visualContinue: "Продовжити",
    stageCaption: "Стратегія · UX · UI · Системи",
    metaExperience: "Досвід",
    metaExperienceValue: "8+ років",
    metaFocus: "Фокус",
    metaLocation: "Локація",
    selectedWorkLabel: "Вибрані роботи",
    selectedWorkTitle: "Кейси, де дизайн упорядковує складність.",
    selectedWorkBody: "Продуктова логіка, масштабовані сценарії та інтерфейси, у яких легко зрозуміти наступну дію.",
    ...
    processLabel: "Процес",
    processTitle: "Від невизначеності — до рішення, яке можна пояснити.",
    processBody: "Не починаю з екранів. Спершу з’ясовую, як працює продукт, де виникає складність і що саме має змінитися.",
    processOneTitle: "Зрозуміти контекст",
    processOneBody: "Цілі бізнесу, користувачі, обмеження, дані та поточна логіка продукту.",
    processTwoTitle: "Упорядкувати сценарії",
    processTwoBody: "Структура, стани, винятки й ключові рішення — до того, як вони стануть UI.",
    processThreeTitle: "Спроєктувати й перевірити",
    processThreeBody: "Прототип, ранній фідбек, ітерації та перевірка критичних сценаріїв.",
    processFourTitle: "Довести до реалізації",
    processFourBody: "Готовий UI, системні компоненти, специфікації та супровід команди розробки.",
    principleLabel: "Мій принцип",
    principleQuote: "«Сильний інтерфейс не пояснює складність — він прибирає її там, де це можливо.»",
    contactLabel: "Контакт",
    contactTitle: "Маєте складний продукт? Давайте зробимо його зрозумілішим.",
    contactBody: "Відкритий до продуктових команд і проєктів, де дизайнер впливає не лише на вигляд, а й на логіку продукту.",
  ...
  en: {
    pageTitle: "Kyrylo Tereshchuk — Product Designer",
    pageDescription: "Portfolio of Kyrylo Tereshchuk — a product designer who makes complex digital products clear.",
    skip: "Skip to content",
    navAria: "Main navigation",
    mobileNavAria: "Mobile navigation",
    languageAria: "Website language",
    heroVisualAria: "Abstract composition of product interfaces",
    caseAreasAria: "Areas of work",
    close: "Close",
    menu: "Menu",
    navWork: "Work",
    navProcess: "Process",
    ...
    heroLineOne: "I turn complex",
    heroLineTwo: "products into clear ones.",
    heroBody: "Product Designer with 8+ years of experience. I design mobile and web products — from logic and user flows to production-ready UI.",
    viewWork: "Explore selected work",
    contactMe: "Get in touch",
    visualProduct: "Product overview",
    visualFlow: "User flow",
    visualClear: "Clear next step",
    visualQuest: "Your next quest",
    visualAction: "Turn action into impact",
    visualContinue: "Continue",
    stageCaption: "Strategy · UX · UI · Systems",
    metaExperience: "Experience",
    metaExperienceValue: "8+ years",
    metaFocus: "Focus",
    metaLocation: "Location",
    selectedWorkLabel: "Selected work",
    selectedWorkTitle: "Cases where design brings order to complexity.",
    selectedWorkBody: "Product logic, scalable flows, and interfaces that make the next step easy to understand.",
    caseQelaTag: "Community platform · Mobile + Admin",
    ...
    processTitle: "From ambiguity to a decision you can explain.",
    processBody: "I do not start with screens. First I learn how the product works, where complexity appears, and what needs to change.",
    processOneTitle: "Understand the context",
    processOneBody: "Business goals, users, constraints, data, and the product's current logic.",
    processTwoTitle: "Structure the flows",
    processTwoBody: "Architecture, states, edge cases, and key decisions — before they become UI.",
    processThreeTitle: "Design and validate",
    processThreeBody: "Prototypes, early feedback, iteration, and validation of critical flows.",
    processFourTitle: "Ship with the team",
    processFourBody: "Production-ready UI, systematic components, specs, and support through implementation.",
    principleLabel: "My principle",
    principleQuote: "“A strong interface does not explain complexity — it removes it wherever possible.”",
    contactLabel: "Contact",
    contactTitle: "Have a complex product? Let’s make it clearer.",
    contactBody: "I am open to product teams and projects where design shapes not only how a product looks, but how it works.",
    writeMe: "Write to me",
...
let currentLanguage = localStorage.getItem("portfolio-language") || "uk";
...
document.querySelectorAll("[data-case]").forEach((button) => {
  button.addEventListener("click", () => {
    const content = translations[currentLanguage].dialogs[button.dataset.case];
...
document.querySelector("#email-link").href = `mailto:${CONTACT_EMAIL}`;
